...
=======
          <p style={{ fontSize: ".82rem", color: "var(--text3)", lineHeight: 1.55 }}>-Expert led courses on crypto, forex, trading, and personal finance.</p>
>>>>>>> fce056a53a657e7f88c584439ab3309e5f7965e5
        </div>
  ...
  return (
    <div style={{ background: "var(--cream)", minHeight: "100vh" }}>
      ...
      <div style={{ padding: "2.5rem", background: "var(--cream2)", borderBottom: "1px solid var(--border)" }}>
        <CategoryBadge cat={course.category} />
        <h1 style={{ color: "var(--text)", fontFamily: "var(--serif)", fontSize: "clamp(1.5rem,3vw,2.2rem)", fontWeight: 700, marginBottom: ".75rem", lineHeight: 1.2, letterSpacing: "-.01em" }}>{course.title}</h1>
